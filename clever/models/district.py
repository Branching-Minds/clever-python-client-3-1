...
class District(object):
    ...
    def __init__(self, district_contact=None, error=None, id=None, last_attendance_sync=None, last_sync=None, launch_date=None, lms_state=None, lms_type=None, login_methods=None, mdr_number=None, name=None, nces_id=None, pause_end=None, pause_start=None, portal_url=None, sis_type=None, state=None):  # noqa: E501
        """District - a model defined in Swagger"""  # noqa: E501
        self._district_contact = None
        self._error = None
        self._id = None
        self._last_attendance_sync = None
        self._last_sync = None
        self._launch_date = None
        self._lms_state = None
        self._lms_type = None
        ...
        if id is not None:
            self.id = id
        if last_attendance_sync is not None:
            self.last_attendance_sync = last_attendance_sync
        if last_sync is not None:
            self.last_sync = last_sync
        if launch_date is not None:
            self.launch_date = launch_date
        if lms_state is not None:
            self.lms_state = lms_state
        if lms_type is not None:
    ...
    @property
    def last_attendance_sync(self):
        """Gets the last_attendance_sync of this District.  # noqa: E501


        :return: The last_attendance_sync of this District.  # noqa: E501
        :rtype: str
        """
        return self._last_attendance_sync

    @last_attendance_sync.setter
    def last_attendance_sync(self, last_attendance_sync):
        """Sets the last_attendance_sync of this District.


        :param last_attendance_sync: The last_attendance_sync of this District.  # noqa: E501
        :type: str
        """

        self._last_attendance_sync = last_attendance_sync
    ...
    @property
    def lms_state(self):
        """Gets the lms_state of this District.  # noqa: E501


        :return: The lms_state of this District.  # noqa: E501
        :rtype: str
        """
        return self._lms_state

    @lms_state.setter
    def lms_state(self, lms_state):
        """Sets the lms_state of this District.


        :param lms_state: The lms_state of this District.  # noqa: E501
        :type: str
        """
        allowed_values = ["matching_in_progress", "error", "disconnected", "", "success"]  # noqa: E501
        if lms_state not in allowed_values:
            raise ValueError(
                "Invalid value for `lms_state` ({0}), must be one of {1}"  # noqa: E501
                .format(lms_state, allowed_values)
            )

        self._lms_state = lms_state

    @property
    def lms_type(self):
        """Gets the lms_type of this District.  # noqa: E501


        :return: The lms_type of this District.  # noqa: E501
        :rtype: str
        """
        return self._lms_type

    @lms_type.setter
    def lms_type(self, lms_type):
        """Sets the lms_type of this District.


        :param lms_type: The lms_type of this District.  # noqa: E501
        :type: str
        """
        allowed_values = ["canvas", "schoology", "google_classroom", ""]  # noqa: E501
        if lms_type not in allowed_values:
            raise ValueError(
                "Invalid value for `lms_type` ({0}), must be one of {1}"  # noqa: E501
                .format(lms_type, allowed_values)
            )
